...
import com.notify.agent.util.SchemaUtil;
...
public class AgentRegistry {
    ...
    private final com.notify.agent.tools.ToolConfig toolConfig;
    ...
    public AgentRegistry(ResourceLoader resourceLoader, com.notify.agent.tools.ToolConfig toolConfig) {
