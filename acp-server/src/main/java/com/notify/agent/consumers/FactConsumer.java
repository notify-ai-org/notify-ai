...
import com.notify.agent.FactRepository;
import com.notify.agent.config.AgentRegistry;
import com.notify.agent.interfaces.MemoryAssembler;
import com.notify.agent.models.FactEntity;
...
public class FactConsumer {
    ...
    private final com.notify.agent.service.SessionService sessionService;
    ...
    public void extractFacts(List<? extends RawLog> logs) {
        ...
        try {
            ...
            com.notify.agent.models.AgentContext context = com.notify.agent.models.AgentContext.builder()
