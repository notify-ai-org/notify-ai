...
import com.notify.agent.NotificationJobRepository;
import com.notify.agent.models.AgentContext;
import com.notify.agent.models.CaptureStatus;
...
public class EventConsumer {
    ...
    private final com.notify.agent.FactRepository factRepository;
                            ...
                            if (reasoningObj != null) {
                                ...
                                if (reasoningObj.containsKey("factsUsed")
                                    ...
                                    for (String factString : factsUsed) {
                                        com.notify.agent.models.FactEntity factE = new com.notify.agent.models.FactEntity();
                                        factE.setClientId(
