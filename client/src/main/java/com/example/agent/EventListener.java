...
public class EventListener {
    ...
    public Object aroundEvent(ProceedingJoinPoint pjp, Event ev) throws Throwable {
        ...
        com.example.agent.models.CallStack callStack = new com.example.agent.models.CallStack();
        List<com.example.agent.models.StackFrame> frames = new ArrayList<>();
        for (StackTraceElement element : limitedStack) {
            com.example.agent.models.StackFrame frame = new com.example.agent.models.StackFrame();
        ...
        if (caughtException != null) {
            // Set exception info
            com.example.agent.models.ExceptionInfo exceptionInfo = new com.example.agent.models.ExceptionInfo();
            ...
            com.example.agent.models.ExecutionResult executionResult = new com.example.agent.models.ExecutionResult();
